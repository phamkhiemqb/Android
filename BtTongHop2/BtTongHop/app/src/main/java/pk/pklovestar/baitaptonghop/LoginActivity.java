...
//                if(edPass.getText().toString().trim()=="") Toast.makeText(LoginActivity.this, "Lỗi: mật khẫu rỗng", Toast.LENGTH_SHORT).show();
//                if(edUser.getText().toString().trim()=="") Toast.makeText(LoginActivity.this, "Lỗi: tên đăng nhập rỗng", Toast.LENGTH_SHORT).show();
                getTokenLogin();
            }
        });
